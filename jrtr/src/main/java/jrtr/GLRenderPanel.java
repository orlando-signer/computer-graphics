 ...
 * to provide an AWT component that displays the rendered image. The class
 * {@link GLRenderContext} performs the actual rendering. The user needs to
 * extend this class and provide an implementation for the <code>init</code>
 * call-back function.
 */
