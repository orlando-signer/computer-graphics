 ...
 * redirects requests to redraw the image (via <code>paintComponent</code>) to
 * the software renderer {@link SWRenderContext}.
 */
public class SWJPanel extends JPanel {
    ...
    /**
     * This class notifies the renderer when it needs to resize its rendered
     * image.
     */
