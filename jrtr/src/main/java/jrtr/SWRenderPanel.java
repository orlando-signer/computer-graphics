 ...
 * <p>
 * The user needs to extend this class and provide an implementation for the
 * <code>init</code> call-back function. To use the software renderer instead of
 * the OpenGL renderer in your application, you will simply derive your render
 * panel from {@link SWRenderPanel} instead of {@link GLRenderPanel}.
 */
